                    ...
                    <div class="table-right-content">
                        <el-dropdown @command="handleCommand">
                            ...
                            <el-dropdown-menu slot="dropdown">
                                <el-dropdown-item icon="el-icon-more-outline" :command="{cmd:'nextLevel',item:t}">属性列表</el-dropdown-item>
    ...
    methods:{
        ...
        handleCommand(cmd) {
            if(cmd.cmd=="nextLevel"){
                this.$router.push({name:'attr',query:{pid:cmd.item.id} })
            }
            if(cmd.cmd=="edit"){
                this.$router.push({name:'updateAttr',params:{obj:cmd.item}})
            }
            if(cmd.cmd=="delete"){
